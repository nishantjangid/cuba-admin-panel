export const MENUITEMS = [
  {
    ...
    Items: [
      ...
      { path: `/app/users/edit`, icon: "user", title: " Profile", type: "link" },
      ...
      //   active: false,
      //   children: [
      //     { path: `/widgets/AllDeposite`, title: "All Deposite", type: "link" },
          // { path: `/widgets/chart`, title: "Chart", type: "link" },
          // { path: `/General/AllDeposite`, title: "All Deposite", type: "link" },
...

  {
    ...
    Items: [
      ...
      //   active: false,
      //   children: [
          // { path: `/app/ecommerce/FundTransfer`, title: "Fund Transfer", type: "link" },
          // { path: `/app/ecommerce/TransferHistory`, title: "Transfer Histroy", type: "link" },
      ...
      //   ],
      // },
      { path: `/app/email-app`, icon: "email", title: "Upgrade Package", type: "link" },
      { path: `/app/todo-app/todo`, icon: "email", title: "Slot Activation", type: "link" },
...

      {
        ...
        active: false,
        children: [
          { path: `/app/chat-app/chats`, type: "link", title: "All User" },
          { path: `/app/chat-app/chat-video-app`, type: "link", title: "My Referral" },
        ],
      },
...

      {
        ...
        active: false,
        children: [
          { path: `/app/ecommerce/cart`, title: "Income Transaction", type: "link" },
          { path: `/app/ecommerce/wishlist`, title: "My Income", type: "link" },
          // { path: `/app/ecommerce/invoice`, title: "MY Team Income", type: "link" },

          // { path: `/app/ecommerce/checkout`, title: "MY Team Income", type: "link" },
      ...
      //   active: false,
      //   children: [
      //     { path: `/app/chat-app/chats`, type: "link", title: "Send Request" },
      //     { path: `/app/chat-app/chat-video-app`, type: "link", title: "Wallet Histroy" },
      //   ],
      // },


      // { path: `/app/bookmark`, icon: "bookmark", type: "link", title: "Transection" },
