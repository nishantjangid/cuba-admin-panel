export const MENUITEMS = [
  {
    ...
    Items: [
      ...
      { path: `${process.env.PUBLIC_URL}/app/users/edit`, icon: "user", title: " Profile", type: "link" },
      ...
      //   active: false,
      //   children: [
      //     { path: `${process.env.PUBLIC_URL}/widgets/AllDeposite`, title: "All Deposite", type: "link" },
          // { path: `${process.env.PUBLIC_URL}/widgets/chart`, title: "Chart", type: "link" },
          // { path: `${process.env.PUBLIC_URL}/General/AllDeposite`, title: "All Deposite", type: "link" },
          // { title: "Approved Deposite", type: "link" },
          // { title: "Pending Deposite", type: "link" },
          // { title: "Reject Deposite", type: "link" },
      //   ],
      // },
    ],
  },

  {
    ...
    Items: [
      ...
      //     { title: "Investments", type: "link" },
      //     { title: "Investment Histroy", type: "link" },
      //     { title: "Admin Investment Histroy", type: "link" },
      ...
      //   active: false,
      //   children: [
          // { path: `${process.env.PUBLIC_URL}/app/ecommerce/FundTransfer`, title: "Fund Transfer", type: "link" },
          // { path: `${process.env.PUBLIC_URL}/app/ecommerce/TransferHistory`, title: "Transfer Histroy", type: "link" },
          ...
          // { title: "Fund Transfers", type: "link" },
          // { title: "User Transfer Histroy", type: "link" },
          // { title: "Admin Transfer Histroy", type: "link" },

      //   ],
      // },
      { path: `${process.env.PUBLIC_URL}/app/email-app`, icon: "email", title: "Upgrade Package", type: "link" },
      { path: `${process.env.PUBLIC_URL}/app/todo-app/todo`, icon: "email", title: "Slot Activation", type: "link" },
...

      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/app/chat-app/chats`, type: "link", title: "All User" },
          { path: `${process.env.PUBLIC_URL}/app/chat-app/chat-video-app`, type: "link", title: "My Referral" },
        ],
      },
...

      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/app/ecommerce/cart`, title: "Income Transaction", type: "link" },
          { path: `${process.env.PUBLIC_URL}/app/ecommerce/wishlist`, title: "My Income", type: "link" },
          // { path: `${process.env.PUBLIC_URL}/app/ecommerce/invoice`, title: "MY Team Income", type: "link" },

          // { path: `${process.env.PUBLIC_URL}/app/ecommerce/checkout`, title: "MY Team Income", type: "link" },

          // { title: "Total Income", type: "link" },
          // { title: "ROI Income", type: "link" },
          // { title: "Level Income", type: "link" },
          // { title: "Reward Income", type: "link" },
          // { title: "My Direct Team", type: "link" },
      ...
      //   active: false,
      //   children: [
      //     { path: `${process.env.PUBLIC_URL}/app/chat-app/chats`, type: "link", title: "Send Request" },
      //     { path: `${process.env.PUBLIC_URL}/app/chat-app/chat-video-app`, type: "link", title: "Wallet Histroy" },
      //   ],
      // },


      // { path: `${process.env.PUBLIC_URL}/app/bookmark`, icon: "bookmark", type: "link", title: "Transection" },
