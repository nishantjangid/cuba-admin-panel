...
import AllDeposite from "../Deposite/AllDeposite";
...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/widgets/AllDeposite/:layout`, Component: <General /> },
  ...
  { path: `${process.env.PUBLIC_URL}/Deposite/AllDeposite`, Component: <AllDeposite /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/FundTransfer/:layout`, Component: <Products /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/TransferHistory/:layout`, Component: <ProductPage /> },
